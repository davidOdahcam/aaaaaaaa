...
<div class="container">
    <div class="content">
        ...
        <form action="./consulta" id="form-hidden" method="post">
            <input type="text" id="input-state-1" name="q1" value="0" hidden>
            <input type="text" id="input-state-2" name="q2" value="0" hidden>
            <input type="text" id="input-state-3" name="q3" value="0" hidden>
            <input type="text" id="input-state-4" name="q4" value="0" hidden>
            <input type="text" id="input-state-5" name="q5" value="0" hidden>
            <input type="text" id="input-state-6" name="q6" value="0" hidden>
            <input type="text" id="input-state-7" name="q7" value="0" hidden>
            <input type="text" id="input-state-8" name="q8" value="0" hidden>
        </form>
        <div class="row">
