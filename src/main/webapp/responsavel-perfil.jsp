                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                     ...
                                     <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="family_history" id="family_history" class="form-control" value="<%= children.get(i).get("family_history") %>" placeholder="Digite o histÃ³rico familiar" required/>
                                    </div>
                                    
                                    <div class="form-group col-md-6">
                                        <label for="name">Histórico patológico</label>
                                        <input type="text" name="pathology_history" id="pathology_history" class="form-control" value="<%= children.get(i).get("pathology_history") %>" placeholder="Digite o histÃ³rico patolÃ³gico" required/>
                                    </div>
