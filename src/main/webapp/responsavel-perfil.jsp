                            ...
                            <form action="./crianca" method="POST" id="ChildrenFormId-<%= children.get(i).get("id") %>" class="form">       
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                     ...
                                     <div class="form-group col-md-6">
                                       <label for="family_history">Hist�rico familiar</label>
                                       <input type="text" name="family_history" id="family_history" class="form-control" value="<%= children.get(i).get("family_history") %>" placeholder="Digite o histórico familiar"/>
                                    </div>
                                    
                                    <div class="form-group col-md-6">
                                       <label for="pathology_history">Hist�rico patol�gico</label>
                                       <input type="text" name="pathology_history" id="pathology_history" class="form-control" value="<%= children.get(i).get("pathology_history") %>" placeholder="Digite o histórico patológico"/>
                                    </div>
